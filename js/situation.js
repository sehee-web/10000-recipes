...
const D3_MAP = {
    'quick':           { 'all': ['snack', 'speed', 'lunchbox'], 'snack': ['snack'], 'speed': ['speed'], 'lunchbox': ['lunchbox'] },
    'special':         { 'all': ['special'] },
    'holiday':         { 'all': ['holiday'] },
    'pregnancy-baby':  { 'all':  ['pregnancy', 'baby'], 'pregnancy': ['pregnancy'], 'baby': ['baby']  },
    'diet':            { 'all': ['diet'] },
    'hangover':        { 'all': ['hangover'] },
    'late-night':      { 'all': ['late-night'] },
};
