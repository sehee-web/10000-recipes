...
const D3_MAP = {
    'boil-simmer':       { 'all': ['boil', 'simmer'],                        'boil': ['boil'],           'simmer': ['simmer'] },
    'stir-grill':        { 'all': ['stir', 'grill'],                          'stir': ['stir'],           'grill': ['grill'] },
    'fry-pan':           { 'all': ['fry', 'pan'],                             'fry': ['fry'],             'pan': ['pan'] },
    'steam-boil-blanch': { 'all': ['steam', 'boil-soft', 'blanch'],           'steam': ['steam'],         'boil-soft': ['boil-soft'],  'blanch': ['blanch'] },
    'mix-toss':          { 'all': ['seasoned', 'bibim'],                      'seasoned': ['seasoned'],   'bibim': ['bibim'] },
    'pickle':            { 'all': ['pickle'],                                  'pickle': ['pickle'] },
    'raw':               { 'all': ['raw'],                                     'raw': ['raw'] },
};
