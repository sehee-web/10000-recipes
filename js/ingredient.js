/* ingredient.js/ D3_MAP + depth1 state 변동*/
...
const D3_MAP = {
    'meat':      { 'all': ['beef', 'pork', 'chicken'], 'beef': ['beef'], 'pork': ['pork'], 'chicken': ['chicken'] },
    'seafood':   { 'all': ['seafood'] },
    'vegetable': { 'all': ['vegetable'] },
    'egg-dairy': { 'all': ['egg', 'dairy'], 'egg': ['egg'], 'dairy': ['dairy'] },
    'flour':     { 'all': ['flour'] },
    'grain-nuts': { 'all': ['grain', 'nuts'], 'grain': ['grain'], 'nuts': ['nuts'] },
    'fruit':     { 'all': ['fruit'] },
};
